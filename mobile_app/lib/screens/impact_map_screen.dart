...
class _ImpactMapScreenState extends State<ImpactMapScreen> with TickerProviderStateMixin {
  ...
  Widget _buildModelViewer(String src, String alt, bool autoRotate) {
    ...
    // Используем WebView на всех нативных платформах.
    // Это стабильнее для iOS Simulator, где model_viewer_plus может падать с DownloadFailed.
    return _buildWebViewModelViewer(src, alt, autoRotate);
  }

  Widget _buildStaticViewer(String alt) {
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment.topCenter,
          end: Alignment.bottomCenter,
          colors: [Color(0xFF10131F), Color(0xFF0A0B10)],
        ),
      ),
      child: Center(
        child: Column(
          ...
          children: [
            const Icon(Icons.public, size: 96, color: Color(0xFF00C853)),
            ...
            Text(
              'Режим 3D временно упрощен для стабильности на iOS',
              textAlign: TextAlign.center,
...
<body>
  <model-viewer
    ...
    exposure="1"
    poster="https://xn--80adnee0afc6kza.com/uploads/image0.jpeg"
